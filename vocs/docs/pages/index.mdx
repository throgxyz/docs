    ...
    <div className="max-sm:px-0 flex justify-between z-0 max-md:justify-center max-md:flex-col max-md:items-center max-md:space-y-6">
      <div className="space-y-8 max-w-[440px] flex flex-col items-start max-md:items-center">
        ...
        <div className="flex justify-center space-x-2">
          ...
          <HomePage.Button href="https://github.com/deszhou/tronz">GitHub</HomePage.Button>
        </div>
      </div>
...
- Report bugs or request features on [GitHub Issues](https://github.com/deszhou/tronz/issues).
- Contributions are welcome — see [CONTRIBUTING.md](https://github.com/deszhou/tronz/blob/main/CONTRIBUTING.md).
